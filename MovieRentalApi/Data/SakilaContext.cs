...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=ASakila;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False;Command Timeout=30");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Actor>(entity =>
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B402518045");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_actor_last_update")
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C8FBF2D624");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_address_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B41832C2C8");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_category_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8C7188570");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_city_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD05581E45556");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_country_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        });
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85F894C2F6");
            ...
            entity.Property(e => e.CreateDate)
                .HasDefaultValueSql("(getdate())", "DF_customer_create_date")
                .HasColumnType("datetime")
            ...
            entity.Property(e => e.LastName)
                ...
                .HasColumnName("last_name");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_customer_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A954899F0F");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_film_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FE942FA7AD");
            ...
            entity.Property(e => e.FilmId).HasColumnName("film_id");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_film_actor_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A3271099E9C");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_film_category_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A9FAED4780");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC49198FB997");
            ...
            entity.Property(e => e.FilmId).HasColumnName("film_id");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_inventory_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
            entity.Property(e => e.StoreId).HasColumnName("store_id");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B3114BB77D");
            ...
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_language_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
            entity.Property(e => e.Name)
                .HasMaxLength(20)
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EAF9751155");
            ...
            entity.Property(e => e.CustomerId).HasColumnName("customer_id");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_payment_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B1E032635");
            ...
            entity.Property(e => e.InventoryId).HasColumnName("inventory_id");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_rental_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9CA8B708D5");
            ...
            entity.Property(e => e.LastName)
                ...
                .HasColumnName("last_name");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_staff_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C8D9C02AB");
            ...
            entity.Property(e => e.AddressId).HasColumnName("address_id");
            entity.Property(e => e.LastUpdate)
                .HasDefaultValueSql("(getdate())", "DF_store_last_update")
                .HasColumnType("datetime")
                .HasColumnName("last_update");
